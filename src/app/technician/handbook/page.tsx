        ...
        <Card>
            ...
            <CardContent>
                <div className="prose lg:prose-lg max-w-none">
                    ...
                    <ol>
                        <li><strong>Payment Policy:</strong> All payments for services must be processed exclusively through the VELOURA platform. Accepting, requesting, or arranging payments outside the app (including cash, personal transfers, or third-party apps) is strictly prohibited. Violation of this policy may result in immediate account suspension or termination.</li>
                        ...
                        <li><strong>Brand Representation:</strong> As a VELOURA partner, you represent our brand in every client interaction. Please use only approved communication channels, respect confidentiality, and uphold our standards of beauty and care excellence.</li>
                        <li><strong>Insurance Requirement:</strong> Professional Cosmetology and Esthetician Liability Insurance is strongly recommended for all VELOURA service providers. If a partner declines to carry active liability insurance or chooses to perform services without coverage, they will be personally responsible for any claims, damages, or errors that occur as a result of their work. VELOURA is not liable for incidents arising from uninsured services.</li>
                    </ol>
                    ...
                    <ul>
                        ...
                        <li>All cancellations and rescheduling must be done through the VELOURA app to ensure tracking and proper notification.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>VELOURA will investigate each case individually.</li>
                    ...
                    <h4>Dress Code</h4>
                    <p>All VELOURA beauty professionals are expected to maintain a clean, polished, and professional appearance at all times when serving clients.</p>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>Never accept or request payments outside the VELOURA platform.</li>
                        <li>Avoid any form of harassment, discrimination, or inappropriate behavior.</li>
                        <li>Refrain from using personal contact information or social media to solicit clients outside of the VELOURA platform.</li>
                    </ul>
                    ...
                    <p>If any injury, damage, or safety concern occurs during a service, the technician must stop the service immediately, provide basic first aid if necessary, and report the incident to VELOURA within 24 hours. Failure to report incidents in a timely manner may result in account suspension.</p>
                    
                    <h2>Legal & Liability Terms</h2>
                    <h4>Insurance & Liability Disclaimer</h4>
                    <p>All VELOURA technicians are strongly encouraged to maintain active professional liability insurance. If a technician provides a service without coverage, they accept full personal responsibility for any damage, claim, or client injury arising from their work. VELOURA is not liable for any incident, injury, or property damage resulting from uninsured services.</p>
                    <h4>Non-Solicitation Clause</h4>
                    <p>Technicians may not solicit or accept direct bookings or payments from VELOURA clients outside of the app. Violating this rule may result in immediate and permanent removal from the platform and possible legal action.</p>
                    <h4>Media & Marketing Consent</h4>
                    <p>VELOURA may request permission to use professional photos, testimonials, or event images for marketing or training purposes. No content will be published without written consent from the technician or client involved.</p>
