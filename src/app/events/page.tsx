                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <Card className="shadow-lg">
                            <CardHeader className="text-center bg-primary/10">
                                ...
                                <CardTitle className="text-3xl font-headline text-primary">VELOURA Recruiting Seminar - Florida</CardTitle>
                            ...
                            <CardContent className="pt-6 text-center space-y-4 text-muted-foreground">
                                <p className="text-lg">
                                    We're thrilled to announce the upcoming VELOURA Recruiting Seminar in our home base of Bal Harbour, Florida - an exclusive, invitation-only event for selected Makeup Artists, Hairstylists, and Nail Technicians.
                                </p>
                                <p>
                                    This seminar will offer hands-on training and professional education designed to empower beauty professionals to understand how to elevate their craft and embrace the future with VELOURA beauty on demand.
                                </p>
                                <div>
                                ...
                                <p className="font-bold text-primary">- The VELOURA Team</p>
                                 <div className="pt-6">
