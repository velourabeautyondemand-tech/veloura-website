            ...
            <main className="flex-1 py-12 md:py-24 bg-secondary/30">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="prose lg:prose-lg max-w-4xl mx-auto bg-card p-8 rounded-xl shadow-md">
                        ...
                        <h2><span className="text-primary text-3xl">1.</span> <span className="font-bold">Core Partner Policies</span></h2>
                        ...
                        <h2><span className="text-primary text-3xl">2.</span> <span className="font-bold">Booking &amp; Payment Policies</span></h2>
                        ...
                        <h2><span className="text-primary text-3xl">3.</span> <span className="font-bold">Operational Policies</span></h2>
                        ...
                        <h2><span className="text-primary text-3xl">4.</span> <span className="font-bold">Legal &amp; Liability Terms</span></h2>
